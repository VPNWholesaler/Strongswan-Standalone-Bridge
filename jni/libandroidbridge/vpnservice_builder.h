...
struct vpnservice_builder_t {
	 ...
	 */
	bool (*add_address)(vpnservice_builder_t *this, host_t *addr, int mtu);
  ...
  void (*set_needok_result)(vpnservice_builder_t *this, char* result, int recvFd);

  bool (*protect_socket)(vpnservice_builder_t *this, int fd);

  bool (*update_status)(vpnservice_builder_t * this, char* status);
 	void (*send_counters)(vpnservice_builder_t * this, int bytes_in, int bytes_out);
